...
# 确保已经安装了openpyxl库
results_df.to_excel('train_result_Decision_Tree.xlsx', index=False, engine='openpyxl')
...
results_df.to_excel('forecast_result_Decision_Tree.xlsx', index=False, engine='openpyxl')